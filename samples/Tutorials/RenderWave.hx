...
class RenderWave extends Sprite
{
    // driver
    ...
    // wave data
    public var drumLoopWave : Array<Float>;
    public var hiQueWave : Array<Float>;
    ...
    public function new()
    {
        ...
        mainMelody.setVoice(0, Reflect.field(presetVoice, "valsound.bass8"));
