...
/** LPF. */
class SiFilterLowPass extends SiFilterBase
{
    // constructor
    //------------------------------------------------------------
    /** constructor.
     ...
     */
    public function new(freq : Float = 800, band : Float = 1)
    {
        super();
     ...
     *  @param band band width [oct].
     */
    public function setParameters(freq : Float = 800, band : Float = 1) : Void{
    ...
    {
        setParameters(((!Math.isNaN(args[0]))) ? args[0] : 800,
