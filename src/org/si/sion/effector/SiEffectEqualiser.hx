...
class SiEffectEqualiser extends SiEffectBase
{
    ...
    //------------------------------------------------------------
    // filter pipes
    private var f1p0L : Float;private var f1p1L : Float;private var f1p2L : Float;private var f1p3L : Float;
    private var f2p0L : Float;private var f2p1L : Float;private var f2p2L : Float;private var f2p3L : Float;
    private var sdm1L : Float;private var sdm2L : Float;private var sdm3L : Float;
    private var f1p0R : Float;private var f1p1R : Float;private var f1p2R : Float;private var f1p3R : Float;
    private var f2p0R : Float;private var f2p1R : Float;private var f2p2R : Float;private var f2p3R : Float;
    private var sdm1R : Float;private var sdm2R : Float;private var sdm3R : Float;
    
    // controls
    private var lf : Float;private var hf : Float;
    private var lg : Float;private var mg : Float;private var hg : Float;
     ...
     */
    public function new(lowGain : Float = 1, midGain : Float = 1, highGain : Float = 1, lowFreq : Float = 880, highFreq : Float = 5000)
    {
        super();
